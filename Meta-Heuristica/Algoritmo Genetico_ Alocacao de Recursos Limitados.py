...
solucao_randomica = Simulated_Annealing.pesquisa_randomica(dominio, funcao_custo)
custo_randomica = funcao_custo(solucao_randomica)
imprimir_solucao(solucao_randomica)

solucao_subida_encosta = Simulated_Annealing.subida_encosta(dominio, funcao_custo)
custo_subida_encosta = funcao_custo(solucao_subida_encosta)
imprimir_solucao(solucao_subida_encosta)  

solucao_tempera = Simulated_Annealing.tempera_simulada(dominio, funcao_custo)
custo_tempera = funcao_custo(solucao_tempera)
imprimir_solucao(solucao_tempera) 

solucao_genetico = Simulated_Annealing.genetico(dominio, funcao_custo)
