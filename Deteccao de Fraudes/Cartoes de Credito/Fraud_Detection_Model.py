...
X_train_node = tf.Variable(tf.float32, [None, input_dimensions], name='X_train')
y_train_node = tf.Variable(tf.float32, [None, output_dimensions], name='y_train')
...
weight_1_node = tf.placeholder(tf.zeros([input_dimensions, num_layer_1_cells]), name='weight_1')
biases_1_node = tf.placeholder(tf.zeros([num_layer_1_cells]), name='biases_1')
